...
import org.apache.maven.wagon.shared.http.WagonRedirectStrategy;
 ...
 */
public abstract class AbstractIpfsClientWagon
    extends StreamWagon
{
    ...
    private static HttpRequestRetryHandler createRetryHandler()
    {
        switch ( RETRY_HANDLER_CLASS )
        {
            ...
            default:
                try
                {
                    final ClassLoader classLoader = AbstractIpfsClientWagon.class.getClassLoader();
    ...
    private static Collection<Class<? extends IOException>> getNonRetryableExceptions()
    {
        ...
        final ClassLoader loader = AbstractIpfsClientWagon.class.getClassLoader();
